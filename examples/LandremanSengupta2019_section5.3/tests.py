...
numFailures += compareToReference(referenceFile,outputFile,'X3s1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'X3s3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'X3c1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'X3c3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Y3s1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Y3s3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Y3c1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Y3c3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Z3s1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Z3s3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Z3c1',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'Z3c3',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
