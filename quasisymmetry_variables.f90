module quasisymmetry_variables
  ...
  character(len=*), parameter :: &
       ...
       order_r_option_r1_compute_B2 = "r1_compute_B2", &
  ...
  real(dp), dimension(:), allocatable :: X20, X2s, X2c, Y20, Y2s, Y2c, Z20, Z2s, Z2c, B20, B2s_array, B2c_array, B02, t1s, t1c
